...
      const res = await request(app).get("/goals/user/608b2f77e6034e31d8239123"); 
...
          dueDate: "2024-12-31T00:00:00.000Z",  // Directly match the string, as it's mock data 

          userId: "608b2f77e6034e31d8239123",   // Consistent with the mock data 
...
    mockingoose(GoalModel).toReturn(mockedGoal, "save"); 
