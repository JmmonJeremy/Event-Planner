...
celebrationRoutes.get('/celebrations/user/:userId', celebrationController.getUsersCrelebrations);
...
celebrationRoutes.post('/celebrations', authenticateJWT, celebrationController.addCelebration);

// #2 the "Put" ROUTE for updating a CELEBRATION selected by celebrationId
celebrationRoutes.put('/celebrations/:celebrationId', authenticateJWT, celebrationController.updateCelebration);

// #3 the "Delete" ROUTE for removing a CELEBRATION selected by celebrationId
celebrationRoutes.delete('/celebrations/:celebrationId', authenticateJWT, celebrationController.deleteCelebration);
